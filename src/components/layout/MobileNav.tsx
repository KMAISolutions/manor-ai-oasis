              ...
              <nav className="flex flex-col space-y-4">
                {menuItems.map((item) => (
                  <Link
                    ...
                    className="text-white text-lg font-medium py-2 px-4 rounded-lg hover:bg-white/10 transition-colors"
                  >
                    {item.label}
                  </Link>
                ))}
                ...
                <div className="flex gap-4 pt-4">
                  <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#D4AF37] transition-colors">
                    <motion.div whileHover={{ scale: 1.1 }} className="p-2 rounded-full bg-white/10">
