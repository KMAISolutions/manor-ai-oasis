      ...
      <div className="relative h-64 md:h-80 flex items-center justify-center">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Contact The King's Court" 
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 hero-gradient"></div>
        </div>
        <div className="container mx-auto px-4 z-10 text-white text-center">
          <h1 className="font-serif text-4xl md:text-5xl font-bold mb-2 text-shadow">Contact Us</h1>
          <p className="text-xl max-w-3xl mx-auto text-shadow">Get in touch with The King's Court Guest Manor</p>
        </div>
      </div>
      ...
      <div className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="font-serif text-3xl mb-4">Find Us</h2>
          ...
          <div className="h-96 rounded-lg overflow-hidden shadow-lg">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3310.2095411462!2d18.42456661575761!3d-33.92518962807456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1dcc67a853553617%3A0x9c746f4df5e5c087!2sCape%20Town%2C%20South%20Africa!5e0!3m2!1sen!2sus!4v1619180021302!5m2!1sen!2sus" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
              allowFullScreen 
