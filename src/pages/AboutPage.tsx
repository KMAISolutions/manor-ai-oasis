      ...
      <div className="py-20 bg-manor-green text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button size="lg" className="text-white px-8 bg-slate-800 hover:bg-slate-700">
              Book Now
            </Button>
            <Link to="/contact">
              <Button size="lg" variant="outline" className="border-white text-white px-8 bg-slate-800 hover:bg-slate-700">
                Contact Us
              </Button>
            </Link>
          </div>
