              ...
              <CardContent className="grid md:grid-cols-2 gap-8 p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    {["Free toiletries", "Toilet", "Bath or shower", "Towels", "Toilet paper"].map((item, idx) => (
                      <div key={idx} className="flex items-center gap-2 text-sm">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {["Air conditioning", "TV", "Flat-screen TV", "Electric kettle", "Wardrobe or closet"].map((facility, idx) => (
                        <div key={idx} className="flex items-center gap-2 text-sm">
                  ...
                  <Button 
                    className="w-full bg-manor-gold hover:bg-manor-gold/90 text-white"
          ...
          <TabsContent value="double-room">
            <Card>
              <CardContent className="grid md:grid-cols-2 gap-8 p-6">
                <div className="relative h-[400px] overflow-hidden rounded-lg">
                  <img 
                    src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/117175723.jpg?k=f40dc9c0aa40beb8dca45e0e894e05a6cb960963e7acf9a8c15f2019e22c2775&o=&hp=1" 
